...
# // Decompiled .NET C# code
# byte[] array = Enumerable.ToArray<byte>(
# 	Enumerable.Select<Ingredient, byte>(
# 		recipe, 
# 		(Ingredient ing) => (byte)(System.Array.IndexOf<string>(IngredientNames, ((object)ing).ToString()) + 32)
# 	)
# );
...
flag = bytes(map(ingredientTxfm, correct))
print(flag)
